...
%%βελτιωμενη μεθοδος με λιγοτερες επαναλήψεις
[sol4,k4,x4,y4,g4]=steepest(f,[-5 10],0.01,x,y,0.1,10/6);
plotting(k4,x4,y4,f,g4);
%%βελτιωμενη μεθοδος με λιγοτερες επαναλήψεις
[sol5,k5,x5,y5,g5]=steepest(f,[-5 10],0.01,x,y,0.1,3);
plotting(k5,x5,y5,f,g5);
%%θεμα3
[sol2,k2,x2,y2,g2]=steepest(f,[-5 10],0.01,x,y,0.1,15);
